import type {notes, workspace, notesSnapshot, assets} from './schema/index';
...
export type CreateLocalWorkspace = Omit<typeof workspace.$inferInsert, 'createdAt' | 'updatedAt' | 'id' | 'userId' | 'workspaceOwnerId' | 'memberIds'>;
...
export type UpdateLocalNoteSnapshot = Partial<typeof notesSnapshot.$inferSelect>;
