...
export const LATEST_MODELS: Record<'openai' | 'claude' | 'gemini' | 'deepseek' | 'kimi' | 'grok', ProviderConfig> = {
  openai: {
    icon: {
  ...
  gemini: {
    ...
    models: {
      'gemini-3.6-flash': {
        ...
        notes: 'Fast flagship Gemini model. 17% fewer tokens in multi-step tasks.',
      },
      'gemini-3.5-flash': {
        ...
        cachedInputCostPerMillion: 0.15,
        notes: 'Frontier intelligence at Flash latency. Knowledge cutoff Jan 2026.',
      },
