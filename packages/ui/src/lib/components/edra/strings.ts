const strings = {
  ...
  extension: {
    audio: {
      ...
      multiplePasteWarningDescription: 'You can only paste one file at a time. Only the first file will be pasted.',
      ...
      multipleDropWarningDescription: 'You can only drop one file at a time. Only the first file will be dropped.',
    ...
    video: {
      ...
      multipleDropWarningTitle: 'Can not drop multiple files at once!',
      multipleDropWarningDescription: 'You can only drop one file at a time. Only the first file will be processed.',
