...
<Tooltip.Provider delayDuration={100}>
	<Tooltip.Root>
		<Tooltip.Trigger class="fixed top-1/3 right-2 z-50 my-auto flex flex-col gap-2 print:hidden">
		...
		<Tooltip.Content
			...
			sideOffset={-24}
			align="start"
			class="flex max-h-120 min-h-8 max-w-56 flex-col items-start gap-1.5 overflow-auto border bg-popover duration-300 fade-in-50 data-[side=left]:slide-in-from-right-30 z-50"
			arrowClasses="hidden"
		>
