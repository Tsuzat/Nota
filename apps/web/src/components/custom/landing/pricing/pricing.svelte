...
<section class="flex w-full flex-col items-center justify-center space-y-7 p-4">
  ...
  <div
    class="mx-auto mt-8 flex w-full max-w-3xl flex-col items-center justify-between rounded-xl border bg-card/60 p-6 shadow-lg backdrop-blur-sm sm:flex-row gap-6 relative overflow-hidden"
  >
    <div
      class="absolute inset-x-0 top-0 h-1 bg-linear-to-r from-emerald-400 to-cyan-400 opacity-80"
    ></div>
    <div class="flex flex-col space-y-2">
      <div class="flex items-center gap-2 text-xl font-bold">
        <Sparkles class="size-5 text-emerald-500" />
        AI Credits Add-on
      </div>
      ...
      <div class="mt-2 flex flex-wrap gap-x-4 gap-y-2 text-sm">
        <div class="flex items-center gap-1.5">
          <CircleCheck class="size-4 text-emerald-500" /> Pay as you go
        </div>
        <div class="flex items-center gap-1.5">
          <CircleCheck class="size-4 text-emerald-500" /> Never expires
        </div>
      </div>
    </div>
    <div class="flex flex-col items-center sm:items-end space-y-3 shrink-0">
      <div class="text-3xl font-extrabold">
        $5<span class="text-base font-normal text-muted-foreground"
          >/top-up</span
        >
      </div>
      <Button
