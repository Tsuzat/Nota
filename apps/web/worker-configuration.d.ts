/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d697a7e8a17e64c48b7edd2924470c0d)
// Runtime types generated with workerd@1.20260811.1 2026-07-25 nodejs_als,nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	PUBLIC_NOTA_FRONTEND_URL: string;
	GITHUB_API_TOKEN: string;
	PUBLIC_BACKEND_URL: string;
	PUBLIC_SENTRY_DSN: string;
	POLAR_MONTLY_SUB: string;
	POLAR_YEARLY_SUB: string;
	POLAR_AI_CREDIT: string;
	SITE_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_NOTA_FRONTEND_URL" | "GITHUB_API_TOKEN" | "PUBLIC_BACKEND_URL" | "PUBLIC_SENTRY_DSN" | "POLAR_MONTLY_SUB" | "POLAR_YEARLY_SUB" | "POLAR_AI_CREDIT" | "SITE_KEY" | "PUBLIC_COLLABORATION_URL">> {}
}
