...
type Session struct {
	...
	PkceChallenge       string    `json:"pkce_challenge" bun:"pkce_challenge,nullzero,default:null"`
	PkceChallengeMethod string    `json:"pkce_challenge_method" bun:"pkce_challenge_method,nullzero"`
